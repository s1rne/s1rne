...
export const resumeData: ResumeData = {
  ...
  summary: "Разработчик с 4+ годами проектной и коммерческой работы. Специализируюсь на React, Node.js, Python и инструментах DevOps. Быстрое саморазвитие, лидерские качества. Опыт подбора и сплочения команд для решения задач. Трудоголик с творческими подходами к решению задач. Мотивирован созданием продуктов, которые приносят реальную пользу людям и обществу.",
  ...
  achievements: [
    {
      title: "Капитан команды-победителя хакатона 'Вайбатон'",
      description: "Первое место на хакатоне от МИСИС",
      date: "2025",
    ...
    {
      title: "Многократный победитель МОШ по робототехнике",
      description: "Многократный победитель Московской олимпиады школьников по робототехнике и ряда других олимпиад",
      date: "2018-2024",
      category: "academic"
    },
    {
      title: "Повышенная стипендия в МИСиС",
      description: "Получение повышенной стипендии за академические достижения",
      date: "2025",
      category: "academic"
    }
  ],
